...
public class TestBase
{
    ...
    protected void ResetMemoryEventBus(Func<IServiceCollection, IServiceCollection> func = null, bool isReset = true, bool isAddLog = true, params Assembly[] assemblies)
    {
        ...
        _services = assemblies == null ? _services.AddTestEventBus(ServiceLifetime.Scoped, _defaultAssemblies) : _services.AddTestEventBus(ServiceLifetime.Scoped, assemblies);
