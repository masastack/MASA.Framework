...
internal class MasaConfigurationProvider : ConfigurationProvider, IRepositoryChangeListener, IDisposable
{
    ...
    public MasaConfigurationProvider(IEnumerable<IConfigurationRepository> repositories)
    {
        _data = new();
        _configurationRepositories = repositories;
