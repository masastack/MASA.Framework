...
public class RedisConfigurationApiClient : ConfigurationApiBase, IConfigurationApiClient
{
    ...
    private readonly ILogger<RedisConfigurationApiClient>? _logger;
    private readonly DccRedisOptions _dccOptions;
    ...
    public RedisConfigurationApiClient(
    ...
    {
        var client = serviceProvider.GetRequiredService<IMultilevelCacheClientFactory>().Create(Constants.DEFAULT_CLIENT_NAME);
        ...
        _logger = serviceProvider.GetService<ILogger<RedisConfigurationApiClient>>();
