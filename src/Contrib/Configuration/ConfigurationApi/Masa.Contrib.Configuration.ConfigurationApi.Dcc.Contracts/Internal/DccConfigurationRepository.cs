...
public class DccConfigurationRepository : AbstractConfigurationRepository
{
    ...
    private async Task Initialize(DccSectionOptions sectionOption)
    {
        ...
        {
            string key = $"{sectionOption.Prefix}{sectionOption.Environment}-{sectionOption.Cluster}-{sectionOption.AppId}-{configObject}".ToLower();
