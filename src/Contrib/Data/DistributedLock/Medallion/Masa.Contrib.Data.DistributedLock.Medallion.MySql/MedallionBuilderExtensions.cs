...
public static class MedallionBuilderExtensions
{
    ...
    public static void UseMySQL<TDbContext>(this MedallionBuilder medallionBuilder,
        Action<MySqlConnectionOptionsBuilder>? options = null) where TDbContext : IMasaDbContext
    {
