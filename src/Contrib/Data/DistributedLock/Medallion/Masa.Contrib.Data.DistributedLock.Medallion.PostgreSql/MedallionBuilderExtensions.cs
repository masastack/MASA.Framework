...
public static class MedallionBuilderExtensions
{
    ...
    public static void UseNpgsql<TDbContext>(this MedallionBuilder medallionBuilder,
        Action<PostgresConnectionOptionsBuilder>? options = null) where TDbContext : IMasaDbContext
    {
