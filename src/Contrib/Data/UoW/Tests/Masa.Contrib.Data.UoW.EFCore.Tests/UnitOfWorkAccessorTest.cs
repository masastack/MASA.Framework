...
public class UnitOfWorkAccessorTest : TestBase
{
    ...
    public async Task TestUnitOfWorkAccessorAsync()
    {
        ...
        Assert.IsTrue(unitOfWorkAccessor!.CurrentDbContextOptions != null &&
            unitOfWorkAccessor.CurrentDbContextOptions.ConnectionString == _connectionString);
        ...
        var unitOfWorkNew2 = unitOfWorkManager.CreateDbContext(new MasaDbContextConfigurationOptions("test"));
