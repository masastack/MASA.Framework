...
namespace Microsoft.Extensions.DependencyInjection
{
    public class OpenTelemetryInstrumentationOptions
    {
        ...
        private readonly static AspNetCoreInstrumentationHandler aspNetCoreInstrumentationHandler = new AspNetCoreInstrumentationHandler();
        private readonly static HttpClientInstrumentHandler httpClientInstrumentHandler = new HttpClientInstrumentHandler();
