...
public class EventBus : IEventBus
{
    ...
    /// <summary>
    /// todo: Awaiting change to documentation site path
    /// </summary>
    private const string LOAD_EVENT_HELP_LINK = "https://github.com/masastack/Masa.Contrib/tree/main/docs/LoadEvent.md";
