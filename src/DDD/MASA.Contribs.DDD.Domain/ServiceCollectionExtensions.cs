...
public static class ServiceCollectionExtensions
{
        ...
        Action<DispatcherOptions>? options = null)
    {
        ...
        CheckAggregateRootRepositories(services, dispatcherOptions.AllAggregateRootTypes);
    ...
    private static void CheckAggregateRootRepositories(this IServiceCollection services, IEnumerable<Type> aggregateRootRepositoryTypes)
    {
